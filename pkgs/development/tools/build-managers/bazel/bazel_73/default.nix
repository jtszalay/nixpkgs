...
let
  ...
  bazel_bootstrap = stdenv.mkDerivation rec {
    ...
    src = fetchurl {
    url = "https://github.com/bazelbuild/bazel/releases/download/7.3.0/bazel_nojdk-7.3.0-linux-x86_64";
    hash = "sha256-jjJo1Ccfhs5lXQX7gNb4eTPrJWlv9bon3c8MJZRqf5c=";
  };
  ...
  outputHash = "sha256-7UwCngT3T05EM0tcVNqX0Dw0Mo3Iio3NnjqWahnXWgU=";
...
stdenv.mkDerivation rec {
  ...
  preBuildPhase = ''
    ...
    ${lndir}/bin/lndir ${bazel_deps}/vendor_dir .
